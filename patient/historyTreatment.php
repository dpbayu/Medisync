                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr>
                            <div class="mb-3">
                                <h5 class="card-subtitle mb-2 text-muted"><i class="fa fa-stethoscope me-2"></i>Illness</h5>
                                <p class="card-text"><?= $medical_record['illness'] ?></p>
                            </div>
                            <div class="mb-3">
                                <h5 class="card-subtitle mb-2 text-muted"><i class="bi bi-chat me-2"></i>Diagnosis</h5>
                                <p class="card-text"><?= $medical_record['diagnosis'] ?></p>
                            </div>
                            <div class="mb-3">
                                <h5 class="card-subtitle mb-2 text-muted"><i class="bi bi-capsule me-2"></i>Medicine</h5>
                                <p class="card-text">
                                <?php
                                    $sql_medicine = "SELECT * FROM tbl_hospital_medicine 
