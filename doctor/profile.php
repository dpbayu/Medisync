                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <form class="forms-sample" action="function.php" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="old_profile" value="<?php echo $_SESSION['profile_doctor'] ?>">
                            <?php
                            if (empty($_SESSION['profile_doctor'])) {
                                echo '<img width="200" height="200" src="../assets/img/User.png" />';
                            } else {
                                echo '<img src="img/' . $_SESSION['profile_doctor'] . '" class="rounded-circle" height="200" width="200">';
                            }
                            ?>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control" type="text" id="name" name="name_doctor" value="<?php echo $_SESSION['name_doctor'] ?>">
                            </div>
                            <div class="form-group mb-3">
                                <label class="form-label" for="email">Email</label>
                                <input class="form-control" type="text" id="email" name="email_doctor" value="<?php echo $_SESSION['email_doctor'] ?>">
                            </div>
                            <div class="form-group mb-3">
