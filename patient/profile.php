                    ...
                    <div class="col-md-6">
                        <form class="forms-sample" action="function.php" method="POST" enctype="multipart/form-data">
                            ...
                            if (empty($_SESSION['profile_patient'])) {
                                ...
                                echo '<img src="img/' . $_SESSION['profile_patient'] . '" class="rounded-circle" height="200" width="200">';
                            }
                            ?>
                            ...
                            <div class="d-flex gap-5">
                                <div class="form-group mb-3 col">
                                    ...
                                    <select class="form-control" id="Religion" name="religion_patient">
                                        ...
                                        <option value="Christian" <?php echo $_SESSION['religion_patient'] == "Christian" ? "selected" : '' ?>>
                                            Christian
                                        </option>
                                        <option value="Chatolic" <?php echo $_SESSION['religion_patient'] == "Chatolic" ? "selected" : '' ?>>
                                            Chatolic
                                        </option>
                                ...
                                <div class="form-group mb-3 col">
                                    ...
                                    <select class="form-control" id="MariaggePatient" name="marriage_patient">
                                        <option value="Married" <?php echo $_SESSION['marriage_patient'] == "Married" ? "selected" : '' ?>>
                                            Married
                                        </option>
                                        <option value="Not Married" <?php echo $_SESSION['marriage_patient'] == "Not Married" ? "selected" : '' ?>>
                                            Not Married
                                        </option>
                                        <option value="Widow" <?php echo $_SESSION['marriage_patient'] == "Widow" ? "selected" : '' ?>>
                                            Widow</option>
                                        <option value="Widower" <?php echo $_SESSION['marriage_patient'] == "Widower" ? "selected" : '' ?>>
                                            Widower</option>
                                    </select>
                                </div>
                            </div>
