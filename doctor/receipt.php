...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle text-center">
            <h1>Receipt <?= $data['name_patient'] ?></h1>
        </div>
            ...
            <form action="function.php" method="POST">
                <div class="row d-flex justify-content-center">
                    <div class="col-md-9 border border-2">
                        ...
                        <table class="table table-bordered text-center">
                            ...
                            <tbody>
                                ...
                                INNER JOIN tbl_medicine ON tbl_hospital_medicine.id_medicine = tbl_medicine.id_medicine
                    ...
                    <div class="col-md-12 my-3 text-center">
                        <button class="btn btn-warning" name="sendPharmacist">Send to Pharmachist</button>
                    </div>
                </div>
            </form>
        </section>
