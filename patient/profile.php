                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <form class="forms-sample" action="function.php" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="old_profile" value="<?php echo $_SESSION['profile_patient'] ?>">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="d-flex gap-3">
                                    <label class="form-label" class="radio-inline">
                                        <input type="radio" name="gender_patient" value="Man"
                                            <?php echo $_SESSION['gender_patient'] == "Man" ? "checked" : null ?>
                                            required> Man
                                    </label>
                                    <label class="form-label" class="radio-inline">
                                        <input type="radio" name="gender_patient" value="Woman"
                                            <?php echo $_SESSION['gender_patient'] == "Woman" ? "checked" : null ?>
                                            required> Woman
                                    </label>
                                </div>
                            </div>
                            <div class="form-group mb-3 col">
                                ...
                                <select class="form-control" id="BloodType" name="blood_patient">
                                    <option value="A" <?php echo $_SESSION['blood_patient'] == "A" ? "selected" : '' ?>>
                                        A
                                    </option>
                                    <option value="B" <?php echo $_SESSION['blood_patient'] == "B" ? "selected" : '' ?>>
                                        B
                                    </option>
                                    <option value="AB"
                                        <?php echo $_SESSION['blood_patient'] == "AB" ? "selected" : '' ?>>AB
                                    </option>
                                    <option value="O" <?php echo $_SESSION['blood_patient'] == "O" ? "selected" : '' ?>>
                                        O</option>
                                </select>
                            </div>
                            <div class="d-flex gap-5">
                                <div class="form-group mb-3 col">
                                    ...
                                    <input class="form-control" type="text" id="birth_place" name="birth_place"
                                        value="<?php echo $_SESSION['birth_place'] ?>" required>
                                </div>
                                <div class="form-group mb-3 col">
                                    ...
                                    <input class="form-control" type="date" id="birth_date" name="birth_date"
                                        value="<?= date('Y-m-d', strtotime($_SESSION["birth_date"])) ?>">
                                </div>
                            </div>
                            <div class="form-group mb-3">
                                <label class="form-label" for="address">Address</label>
                                <input class="form-control" type="text" id="address" name="address_patient"
                                    value="<?php echo $_SESSION['address_patient'] ?>">
                            </div>
                            <div class="form-group mb-3">
                                <label class="form-label" for="phone">Phone</label>
                                <input class="form-control" type="number" id="phone" name="phone_patient"
                                    value="<?php echo $_SESSION['phone_patient'] ?>">
                            </div>
                            <div class="d-flex gap-5">
                                <div class="form-group mb-3 col">
                                    ...
                                    <select class="form-control" id="Religion" name="religion_patient">
                                        <option value="Islam"
                                            <?php echo $_SESSION['religion_patient'] == "Islam" ? "selected" : '' ?>>
                                            Islam
                                        </option>
                                        <option value="Christian"
                                            <?php echo $_SESSION['religion_patient'] == "Christian" ? "selected" : '' ?>>
                                            Christian
                                        </option>
                                        <option value="Chatolic"
                                            <?php echo $_SESSION['religion_patient'] == "Chatolic" ? "selected" : '' ?>>
                                            Chatolic
                                        </option>
                                        <option value="Hindu"
                                            <?php echo $_SESSION['religion_patient'] == "Hindu" ? "selected" : '' ?>>
                                            Hindu</option>
                                        <option value="Budha"
                                            <?php echo $_SESSION['religion_patient'] == "Budha" ? "selected" : '' ?>>
                                            Budha</option>
                                    </select>
                                </div>
                                <div class="form-group mb-3 col">
                                    ...
                                    <select class="form-control" id="MariaggePatient" name="marriage_patient">
                                        <option value="Married"
                                            <?php echo $_SESSION['marriage_patient'] == "Married" ? "selected" : '' ?>>
                                            Married
                                        </option>
                                        <option value="Not Married"
                                            <?php echo $_SESSION['marriage_patient'] == "Not Married" ? "selected" : '' ?>>
                                            Not Married
                                        </option>
                                        <option value="Widow"
                                            <?php echo $_SESSION['marriage_patient'] == "Widow" ? "selected" : '' ?>>
                                            Widow</option>
                                        <option value="Widower"
                                            <?php echo $_SESSION['marriage_patient'] == "Widower" ? "selected" : '' ?>>
                                            Widower</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control" type="email" id="email" name="email_patient"
                    ...
                    <div class="col-md-6">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td class="text-center"><img src="img/<?php echo $_SESSION['profile_patient'] ?>"
                            ...
                            <tr>
                                ...
                                <td><?php echo $_SESSION['birth_place'] ?>,
                                    <?php echo date("j F Y", strtotime($_SESSION['birth_date'])) ?></td>
                            </tr>
                            <tr>
                                <td>Address</td>
